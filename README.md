...
* [**Electron Twitter Tools**](https://github.com/tomshaw/electron-twitter-tools): A power user Twitter client that features list maintenance, customizable search, geographic and sentiment analysis and much more.
